...
const makeMoveIdsToMoves = cubeSize => {
  ...
  const slices = [
    ...
    [xRotationMatrices3, CL.pitchSliceCoordsList(allCoordsList, -1).concat(CL.pitchSliceCoordsList(allCoordsList, 0))],
    [xRotationMatrices3, CL.pitchSliceCoordsList(allCoordsList, 0).concat(CL.pitchSliceCoordsList(allCoordsList, 1))],
    [yRotationMatrices3, CL.yawSliceCoordsList(allCoordsList, -1).concat(CL.yawSliceCoordsList(allCoordsList, 0))],
    [yRotationMatrices3, CL.yawSliceCoordsList(allCoordsList, 0).concat(CL.yawSliceCoordsList(allCoordsList, 1))],
    [zRotationMatrices3, CL.rollSliceCoordsList(allCoordsList, -1).concat(CL.rollSliceCoordsList(allCoordsList, 0))],
    [zRotationMatrices3, CL.rollSliceCoordsList(allCoordsList, 0).concat(CL.rollSliceCoordsList(allCoordsList, 1))],
...
export const makePerCubeSizeDataEntry = cubeSize => {
